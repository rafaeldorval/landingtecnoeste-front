...
import PromoImg from '../../assets/images/promobanner.png';
    ...
    <div className="min-w-screen background-banner md:h-3/4 flex flex-col items-center justify-center w-full">
      <div className="flex items-center justify-center flex-col md:flex-row h-11/12 w-full p-4">
        <div className="md:flex-1 md:h-full flex flex-col items-center justify-center md:items-end">
          ...
          <p className="text-4xl md:text-5xl md:-mt-8 font-bold text-white w-full md:w-auto">Melhore o<br />desempenho das<br />suas máquinas!</p>
        </div>
      ...
      <div className="flex items-center justify-center md:flex-row h-1/12 w-full">
        <BouncyDiv>
          <div className="flex md:hidden lg:hidden xl:hidden">
            <ScrollTo>
              {({ scroll }) => (
                <a
                  onClick={() => scroll({ y: 1300, smooth: true })}
                  className="text-white font-bold flex flex-col items-center"
                >
                  Veja mais
                  <BiDownArrowAlt color="#fff" className="text-5xl" />
                </a>
              )}
            </ScrollTo>
          </div>
        ...
        <BouncyDiv>
          <div className="hidden md:flex lg:flex xl:flex">
            <ScrollTo>
              {({ scroll }) => (
                <a
                  onClick={() => scroll({ y: 800, smooth: true })}
                  className="text-white font-bold flex flex-col items-center"
                >
                  Veja mais
                  <BiDownArrowAlt color="#fff" className="text-5xl" />
